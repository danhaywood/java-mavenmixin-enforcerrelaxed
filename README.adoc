...
This module provides a link:https://github.com/odavid/maven-plugins[maven mixin] that can be incorporated into Maven module, defining a "relaxed" configuration (without link:http://maven.apache.org/enforcer/maven-enforcer-plugin/dependency-convergence.html[dependency convergence checking]) for the  link:http://maven.apache.org/enforcer/maven-enforcer-plugin/[enforcer] plugin.
